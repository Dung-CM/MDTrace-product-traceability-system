                    ...
                    <tr class="hover:bg-gray-50 transition">
                        <td class="px-6 py-3">
                            @if($product->image_url)
                                <img src="{{ str_starts_with($product->image_url ?? '', 'http') ? $product->image_url : asset('storage/' . $product->image_url) }}" alt="{{ $product->name }}" class="w-12 h-12 rounded-lg object-cover border border-gray-200">
                            @else
